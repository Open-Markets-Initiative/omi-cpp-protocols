...
struct Statistics {
    ...
    void udp() {
        ...
        iex::iexequities::deep::iextp::v1_06::process_segment(*this, frame.payload, frame.payload_len, parser.source.timestamp_ns(), frame);
    ...
    iex::iexequities::deep::iextp::v1_06::seq_action on_transport_header(const iex::iexequities::deep::iextp::v1_06::iextp_header& transport, const packet::Frame&) {
        if (transport.message_count.get().value() == 0) {
            ++heartbeats;
            return iex::iexequities::deep::iextp::v1_06::seq_action::skip;
        }

        total_messages += transport.message_count.get().value();

        return iex::iexequities::deep::iextp::v1_06::seq_action::process;
    }

    // one overload per dispatched message
    void on_message(const iex::iexequities::deep::iextp::v1_06::system_event_message&, std::uint64_t, const iex::iexequities::deep::iextp::v1_06::iextp_header&)
        { ++system_event_message; ++matched_messages; }
    void on_message(const iex::iexequities::deep::iextp::v1_06::security_directory_message&, std::uint64_t, const iex::iexequities::deep::iextp::v1_06::iextp_header&)
        { ++security_directory_message; ++matched_messages; }
    void on_message(const iex::iexequities::deep::iextp::v1_06::trading_status_message&, std::uint64_t, const iex::iexequities::deep::iextp::v1_06::iextp_header&)
        { ++trading_status_message; ++matched_messages; }
    void on_message(const iex::iexequities::deep::iextp::v1_06::operational_halt_status_message&, std::uint64_t, const iex::iexequities::deep::iextp::v1_06::iextp_header&)
        { ++operational_halt_status_message; ++matched_messages; }
    void on_message(const iex::iexequities::deep::iextp::v1_06::short_sale_price_test_status_message&, std::uint64_t, const iex::iexequities::deep::iextp::v1_06::iextp_header&)
        { ++short_sale_price_test_status_message; ++matched_messages; }
    void on_message(const iex::iexequities::deep::iextp::v1_06::security_event_message&, std::uint64_t, const iex::iexequities::deep::iextp::v1_06::iextp_header&)
        { ++security_event_message; ++matched_messages; }
    void on_message(const iex::iexequities::deep::iextp::v1_06::price_level_buy_update_message&, std::uint64_t, const iex::iexequities::deep::iextp::v1_06::iextp_header&)
        { ++price_level_buy_update_message; ++matched_messages; }
    void on_message(const iex::iexequities::deep::iextp::v1_06::price_level_sell_update_message&, std::uint64_t, const iex::iexequities::deep::iextp::v1_06::iextp_header&)
        { ++price_level_sell_update_message; ++matched_messages; }
    void on_message(const iex::iexequities::deep::iextp::v1_06::trade_report_message&, std::uint64_t, const iex::iexequities::deep::iextp::v1_06::iextp_header&)
        { ++trade_report_message; ++matched_messages; }
    void on_message(const iex::iexequities::deep::iextp::v1_06::official_price_message&, std::uint64_t, const iex::iexequities::deep::iextp::v1_06::iextp_header&)
        { ++official_price_message; ++matched_messages; }
    void on_message(const iex::iexequities::deep::iextp::v1_06::trade_break_message&, std::uint64_t, const iex::iexequities::deep::iextp::v1_06::iextp_header&)
        { ++trade_break_message; ++matched_messages; }
    void on_message(const iex::iexequities::deep::iextp::v1_06::auction_information_message&, std::uint64_t, const iex::iexequities::deep::iextp::v1_06::iextp_header&)
