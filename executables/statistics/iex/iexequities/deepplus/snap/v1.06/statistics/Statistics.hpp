...
#include "cpp/modern/iex/iexequities/deepplus/snap/v1.06/definitions.hpp"
...
struct Statistics {
    ...
    iex::iexequities::deepplus::snap::v1_06::MessageIterator message;
    ...
    void process_message(const std::byte* pointer, const char message_type) {
        switch (message_type) {
            ...
            case 'd':
                ...
                {
                    const auto* sub_header = iex::iexequities::deepplus::snap::v1_06::SnapshotDataMessage::parse(pointer);
