...
struct Statistics {
    ...
    void udp() {
        ...
        iex::iexequities::deepplus::iextp::v1_05::process_segment(*this, frame.payload, frame.payload_len, parser.source.timestamp_ns(), frame);
    ...
    iex::iexequities::deepplus::iextp::v1_05::seq_action on_transport_header(const iex::iexequities::deepplus::iextp::v1_05::iextp_header& transport, const packet::Frame&) {
        if (transport.message_count.get().value() == 0) {
            ++heartbeats;
            return iex::iexequities::deepplus::iextp::v1_05::seq_action::skip;
        }

        total_messages += transport.message_count.get().value();

        return iex::iexequities::deepplus::iextp::v1_05::seq_action::process;
    }

    // one overload per dispatched message
    void on_message(const iex::iexequities::deepplus::iextp::v1_05::system_event_message&, std::uint64_t, const iex::iexequities::deepplus::iextp::v1_05::iextp_header&)
        { ++system_event_message; ++matched_messages; }
    void on_message(const iex::iexequities::deepplus::iextp::v1_05::security_directory_message&, std::uint64_t, const iex::iexequities::deepplus::iextp::v1_05::iextp_header&)
        { ++security_directory_message; ++matched_messages; }
    void on_message(const iex::iexequities::deepplus::iextp::v1_05::trading_status_message&, std::uint64_t, const iex::iexequities::deepplus::iextp::v1_05::iextp_header&)
        { ++trading_status_message; ++matched_messages; }
    void on_message(const iex::iexequities::deepplus::iextp::v1_05::retail_liquidity_indicator_message&, std::uint64_t, const iex::iexequities::deepplus::iextp::v1_05::iextp_header&)
        { ++retail_liquidity_indicator_message; ++matched_messages; }
    void on_message(const iex::iexequities::deepplus::iextp::v1_05::operational_halt_status_message&, std::uint64_t, const iex::iexequities::deepplus::iextp::v1_05::iextp_header&)
        { ++operational_halt_status_message; ++matched_messages; }
    void on_message(const iex::iexequities::deepplus::iextp::v1_05::short_sale_price_test_status_message&, std::uint64_t, const iex::iexequities::deepplus::iextp::v1_05::iextp_header&)
        { ++short_sale_price_test_status_message; ++matched_messages; }
    void on_message(const iex::iexequities::deepplus::iextp::v1_05::security_event_message&, std::uint64_t, const iex::iexequities::deepplus::iextp::v1_05::iextp_header&)
        { ++security_event_message; ++matched_messages; }
    void on_message(const iex::iexequities::deepplus::iextp::v1_05::add_order_message&, std::uint64_t, const iex::iexequities::deepplus::iextp::v1_05::iextp_header&)
        { ++add_order_message; ++matched_messages; }
    void on_message(const iex::iexequities::deepplus::iextp::v1_05::order_modify_message&, std::uint64_t, const iex::iexequities::deepplus::iextp::v1_05::iextp_header&)
        { ++order_modify_message; ++matched_messages; }
    void on_message(const iex::iexequities::deepplus::iextp::v1_05::order_delete_message&, std::uint64_t, const iex::iexequities::deepplus::iextp::v1_05::iextp_header&)
        { ++order_delete_message; ++matched_messages; }
    void on_message(const iex::iexequities::deepplus::iextp::v1_05::order_executed_message&, std::uint64_t, const iex::iexequities::deepplus::iextp::v1_05::iextp_header&)
        { ++order_executed_message; ++matched_messages; }
    void on_message(const iex::iexequities::deepplus::iextp::v1_05::trade_message&, std::uint64_t, const iex::iexequities::deepplus::iextp::v1_05::iextp_header&)
        { ++trade_message; ++matched_messages; }
    void on_message(const iex::iexequities::deepplus::iextp::v1_05::trade_break_message&, std::uint64_t, const iex::iexequities::deepplus::iextp::v1_05::iextp_header&)
        { ++trade_break_message; ++matched_messages; }
    void on_message(const iex::iexequities::deepplus::iextp::v1_05::clear_book_message&, std::uint64_t, const iex::iexequities::deepplus::iextp::v1_05::iextp_header&)
