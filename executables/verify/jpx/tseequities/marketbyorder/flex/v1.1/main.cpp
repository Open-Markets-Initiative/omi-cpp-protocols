// Jpx.TseEquities.MarketByOrder.Flex.v1.1 verifier.
//
...
void summarize(const Tally& tally) {
    std::printf("== Jpx.TseEquities.MarketByOrder.Flex.v1.1 verify\n");
...
int main(int argc, char** argv) {
    ...
    while (captures.advance()) {
        ...
        for (const protocol::Frame& held : decoded.frames()) {
            ...
            const std::size_t declared = static_cast<std::size_t>(held.message_header().tag_length()) + 1;
