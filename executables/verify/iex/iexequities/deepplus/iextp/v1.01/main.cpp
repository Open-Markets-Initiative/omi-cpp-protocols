// Iex.IexEquities.DeepPlus.IexTp.v1.01 verifier.
//
...
#include "Frame.hpp"
#include "cpp/classes/iex/iexequities/deepplus/iextp/v1.01/definitions.hpp"
...
void summarize(const Tally& tally) {
    std::printf("== Iex.IexEquities.DeepPlus.IexTp.v1.01 verify\n");
