// Iex.IexEquities.DeepPlus.Snap.v1.06 verifier.
//
...
#include "cpp/classes/iex/iexequities/deepplus/snap/v1.06/definitions.hpp"
...
void summarize(const Tally& tally) {
    std::printf("== Iex.IexEquities.DeepPlus.Snap.v1.06 verify\n");
    std::printf("%-12s %zu\n", "reads", tally.packets);
