// Iex.IexEquities.DeepPlus.Snap.v1.05 verifier.
//
...
#include "cpp/classes/iex/iexequities/deepplus/snap/v1.05/definitions.hpp"

namespace protocol = ::iex::iexequities::deepplus::snap::v1_05;
...
void summarize(const Tally& tally) {
    std::printf("== Iex.IexEquities.DeepPlus.Snap.v1.05 verify\n");
    std::printf("%-12s %zu\n", "reads", tally.packets);
...
int main(int argc, char** argv) {
    ...
    for (const auto& [key, buffer] : buffers) { unread += buffer.size(); }

    if (unread > 0) {
        std::fprintf(stderr, "%zu bytes left unread at the end of the capture\n", unread);
    }
