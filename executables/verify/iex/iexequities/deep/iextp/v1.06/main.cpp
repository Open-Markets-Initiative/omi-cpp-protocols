// Iex.IexEquities.Deep.IexTp.v1.06 verifier.
//
...
#include "Frame.hpp"
#include "cpp/classes/iex/iexequities/deep/iextp/v1.06/definitions.hpp"
...
void summarize(const Tally& tally) {
    std::printf("== Iex.IexEquities.Deep.IexTp.v1.06 verify\n");
