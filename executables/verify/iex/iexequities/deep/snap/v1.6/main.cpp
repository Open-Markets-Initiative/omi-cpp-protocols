// Iex.IexEquities.Deep.Snap.v1.6 verifier.
//
...
#include "cpp/classes/iex/iexequities/deep/snap/v1.6/definitions.hpp"

namespace protocol = ::iex::iexequities::deep::snap::v1_6;
...
void summarize(const Tally& tally) {
    std::printf("== Iex.IexEquities.Deep.Snap.v1.6 verify\n");
    std::printf("%-12s %zu\n", "reads", tally.packets);
