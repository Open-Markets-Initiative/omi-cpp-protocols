// Generated by Scaled.Historical.Extractor.Cpp — packet sampling logic for Nasdaq.NsmEquities.TotalView.Itch.v5.0.2023.
#pragma once
...
inline int sample(const fs::path& in_path, const fs::path& out_dir) {
    ...
    auto walk_message = [&](const packet::Frame& frame) {
        nasdaq::nsmequities::totalview::itch::v5_0_2023::MessageIterator messages;
