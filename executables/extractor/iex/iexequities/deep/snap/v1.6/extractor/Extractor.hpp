// Generated by Scaled.Historical.Extractor.Cpp — packet sampling logic for Iex.IexEquities.Deep.Snap.v1.6.
#pragma once
...
inline int sample(const fs::path& in_path, const fs::path& out_dir) {
    ...
    reassembler_message.on_data = [&](const packet::TcpFlowKey& key, const std::byte* data, std::size_t len) {
        ...
        iex::iexequities::deep::snap::v1_6::MessageIterator packets;
        ...
        while (packets.next()) {
            ...
            switch (id) {
                case 100:
                    if (packets.message + sizeof(iex::iexequities::deep::snap::v1_6::SnapshotDataMessage) <= packets.current) {
                        id = (id << 32) | key_of(iex::iexequities::deep::snap::v1_6::SnapshotDataMessage::parse(packets.message)->iex_tp_message_type.get());
                    }
                    break;
                default:
                    break;
