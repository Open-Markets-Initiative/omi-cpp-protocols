...
struct SystemEventMessage {
    ...
    static const SystemEventMessage* parse(const SnapshotDataMessage* header) {
        return reinterpret_cast<const SystemEventMessage*>(reinterpret_cast<const std::byte*>(header) + sizeof(SnapshotDataMessage));
    }
};
