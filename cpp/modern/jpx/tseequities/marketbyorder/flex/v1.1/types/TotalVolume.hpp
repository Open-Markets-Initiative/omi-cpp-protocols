...
// Total volume of executed orders in number of shares
struct TotalVolume {

    static constexpr auto name = "Total Volume";
    ...
    // default constructor
    constexpr TotalVolume()
     : value{ 0 } {}

    // standard constructor
    constexpr explicit TotalVolume(const std::uint64_t value)
     : value{ bytes(value) } {}

    // get value of TotalVolume field
