...
// Total volume of invalidated orders in number of shares
struct TotalInvalidation {

    static constexpr auto name = "Total Invalidation";
    ...
    // default constructor
    constexpr TotalInvalidation()
     : value{ 0 } {}

    // standard constructor
    constexpr explicit TotalInvalidation(const std::uint64_t value)
     : value{ bytes(value) } {}

    // get value of TotalInvalidation field
