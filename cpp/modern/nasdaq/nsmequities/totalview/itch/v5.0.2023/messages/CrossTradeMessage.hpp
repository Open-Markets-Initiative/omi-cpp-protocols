...
struct CrossTradeMessage {
    ...
    static const CrossTradeMessage* parse(const MessageHeader* header) {
        return reinterpret_cast<const CrossTradeMessage*>(reinterpret_cast<const std::byte*>(header) + sizeof(MessageHeader));
    }
};
