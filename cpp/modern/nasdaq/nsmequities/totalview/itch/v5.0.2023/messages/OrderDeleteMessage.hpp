...
struct OrderDeleteMessage {
    ...
    static const OrderDeleteMessage* parse(const SequencedDataPacket* header) {
        return reinterpret_cast<const OrderDeleteMessage*>(reinterpret_cast<const std::byte*>(header) + sizeof(SequencedDataPacket));
    }
};
