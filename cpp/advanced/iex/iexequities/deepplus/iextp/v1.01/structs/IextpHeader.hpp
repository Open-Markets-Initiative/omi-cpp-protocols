...
struct iextp_header {
    ...
    iextp_deepplus::version version;
    iextp_deepplus::reserved reserved;
    iextp_deepplus::message_protocol_id message_protocol_id;
    iextp_deepplus::channel_id channel_id;
    iextp_deepplus::session_id session_id;
    iextp_deepplus::payload_length payload_length;
    iextp_deepplus::message_count message_count;
    iextp_deepplus::stream_offset stream_offset;
    iextp_deepplus::first_message_sequence_number first_message_sequence_number;
    iextp_deepplus::send_time send_time;
