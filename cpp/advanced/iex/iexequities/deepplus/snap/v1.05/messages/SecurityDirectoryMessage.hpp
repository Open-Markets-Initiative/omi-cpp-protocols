...
struct security_directory_message {
    ...
    struct fields_type {
        snap_deepplus::security_directory_flags security_directory_flags;
        snap_deepplus::timestamp timestamp;
        snap_deepplus::symbol symbol;
        snap_deepplus::round_lot_size round_lot_size;
        snap_deepplus::adjusted_poc_price adjusted_poc_price;
