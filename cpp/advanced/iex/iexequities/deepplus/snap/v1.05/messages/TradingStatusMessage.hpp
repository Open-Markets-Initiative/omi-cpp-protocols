...
struct trading_status_message {
    ...
    struct fields_type {
        snap_deepplus::trading_status trading_status;
        snap_deepplus::timestamp timestamp;
        snap_deepplus::symbol symbol;
        snap_deepplus::reason reason;
    };
    ...
    snap_deepplus::iex_tp_message_type iex_tp_message_type = snap_deepplus::iex_tp_message_type::enum_type::trading_status_message;
...
static_assert(sizeof(trading_status_message) == sizeof(message_header) + sizeof(snap_deepplus::iex_tp_header) + sizeof(snap_deepplus::iex_tp_message_block_length) + sizeof(snap_deepplus::iex_tp_message_length) + sizeof(snap_deepplus::iex_tp_message_type) + 21, "unexpected sizeof trading_status_message");
