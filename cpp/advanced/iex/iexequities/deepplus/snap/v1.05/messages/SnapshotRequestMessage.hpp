...
struct snapshot_request_message {
    ...
    struct fields_type {
        snap_deepplus::authentication_token authentication_token;
        snap_deepplus::channel_id channel_id;
        snap_deepplus::session_id session_id;
        snap_deepplus::minimum_sequence_number minimum_sequence_number;
    };
