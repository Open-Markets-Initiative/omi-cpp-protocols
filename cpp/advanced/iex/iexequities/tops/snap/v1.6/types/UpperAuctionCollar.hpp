...
struct upper_auction_collar {

    static constexpr const char* name = "upper_auction_collar";
    ...
    constexpr upper_auction_collar()
     : value{ 0 } {}

    constexpr upper_auction_collar(std::int64_t v)
     : value{ v } {}
