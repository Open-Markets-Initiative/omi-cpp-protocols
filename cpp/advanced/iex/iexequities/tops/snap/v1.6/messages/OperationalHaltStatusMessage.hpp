...
struct operational_halt_status_message {
    ...
    struct fields_type {
        snap_tops::operational_halt_status operational_halt_status;
    ...
    snap_tops::iex_tp_message_type iex_tp_message_type = snap_tops::iex_tp_message_type::enum_type::operational_halt_status_message;
...
static_assert(sizeof(operational_halt_status_message) == sizeof(message_header) + sizeof(snap_tops::iex_tp_header) + sizeof(snap_tops::iex_tp_message_block_length) + sizeof(snap_tops::iex_tp_message_length) + sizeof(snap_tops::iex_tp_message_type) + 17, "unexpected sizeof operational_halt_status_message");
