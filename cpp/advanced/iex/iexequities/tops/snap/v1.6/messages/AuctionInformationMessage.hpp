...
struct auction_information_message {
    ...
    struct fields_type {
        snap_tops::auction_type auction_type;
        snap_tops::timestamp timestamp;
        snap_tops::symbol symbol;
        snap_tops::paired_shares paired_shares;
        snap_tops::reference_price reference_price;
        snap_tops::indicative_clearing_price indicative_clearing_price;
        snap_tops::imbalance_shares imbalance_shares;
        snap_tops::imbalance_side imbalance_side;
        snap_tops::extension_number extension_number;
        snap_tops::scheduled_auction_time scheduled_auction_time;
        snap_tops::auction_book_clearing_price auction_book_clearing_price;
        snap_tops::collar_reference_price collar_reference_price;
        snap_tops::lower_auction_collar lower_auction_collar;
        snap_tops::upper_auction_collar upper_auction_collar;
    };
    ...
    snap_tops::iex_tp_message_type iex_tp_message_type = snap_tops::iex_tp_message_type::enum_type::auction_information_message;
...
static_assert(sizeof(auction_information_message) == sizeof(message_header) + sizeof(snap_tops::iex_tp_header) + sizeof(snap_tops::iex_tp_message_block_length) + sizeof(snap_tops::iex_tp_message_length) + sizeof(snap_tops::iex_tp_message_type) + 79, "unexpected sizeof auction_information_message");
