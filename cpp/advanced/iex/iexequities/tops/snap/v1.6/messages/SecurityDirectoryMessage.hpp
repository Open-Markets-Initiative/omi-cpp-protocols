...
struct security_directory_message {
    ...
    struct fields_type {
        snap_tops::security_directory_flags security_directory_flags;
        snap_tops::timestamp timestamp;
        snap_tops::symbol symbol;
        snap_tops::round_lot_size round_lot_size;
        snap_tops::adjusted_poc_price adjusted_poc_price;
        snap_tops::luld_tier luld_tier;
    };
    ...
    snap_tops::iex_tp_message_type iex_tp_message_type = snap_tops::iex_tp_message_type::enum_type::security_directory_message;
...
static_assert(sizeof(security_directory_message) == sizeof(message_header) + sizeof(snap_tops::iex_tp_header) + sizeof(snap_tops::iex_tp_message_block_length) + sizeof(snap_tops::iex_tp_message_length) + sizeof(snap_tops::iex_tp_message_type) + 30, "unexpected sizeof security_directory_message");
