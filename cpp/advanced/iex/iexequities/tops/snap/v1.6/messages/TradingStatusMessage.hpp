...
struct trading_status_message {
    ...
    struct fields_type {
        snap_tops::trading_status trading_status;
        snap_tops::timestamp timestamp;
        snap_tops::symbol symbol;
        snap_tops::reason reason;
    };
    ...
    snap_tops::iex_tp_message_type iex_tp_message_type = snap_tops::iex_tp_message_type::enum_type::trading_status_message;
...
static_assert(sizeof(trading_status_message) == sizeof(message_header) + sizeof(snap_tops::iex_tp_header) + sizeof(snap_tops::iex_tp_message_block_length) + sizeof(snap_tops::iex_tp_message_length) + sizeof(snap_tops::iex_tp_message_type) + 21, "unexpected sizeof trading_status_message");
