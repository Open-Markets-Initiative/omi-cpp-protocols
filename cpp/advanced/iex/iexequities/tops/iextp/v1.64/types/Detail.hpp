...
struct detail {
    ...
    static constexpr std::string_view to_string(enum_type value) {
        switch (value) {
            ...
            case enum_type::detail_not_available: return "Detail Not Available";
    ...
    constexpr void set(result_type value) {
        if (value.has_value())
            ...
            set(enum_type::detail_not_available);
    }
