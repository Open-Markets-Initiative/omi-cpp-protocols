...
struct auction_information_message {
    ...
    struct fields_type {
        iextp_deep::auction_type auction_type;
        iextp_deep::timestamp timestamp;
        iextp_deep::symbol symbol;
        iextp_deep::paired_shares paired_shares;
        iextp_deep::reference_price reference_price;
        iextp_deep::indicative_clearing_price indicative_clearing_price;
        iextp_deep::imbalance_shares imbalance_shares;
        iextp_deep::imbalance_side imbalance_side;
        iextp_deep::extension_number extension_number;
        iextp_deep::scheduled_auction_time scheduled_auction_time;
        iextp_deep::auction_book_clearing_price auction_book_clearing_price;
        iextp_deep::collar_reference_price collar_reference_price;
        iextp_deep::lower_auction_collar lower_auction_collar;
