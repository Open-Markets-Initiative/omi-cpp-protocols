...
inline std::ostream& operator<<(std::ostream& os, const message_header& value) {
    os << "message_length=" << value.message_length.get().value()
       << ",message_type=\"" << snap_deep::message_type::to_string(value.message_type.get().value()) << '"'
       ;
    return os;
}
...
inline std::ostream& operator<<(std::ostream& os, const error_response_message& msg) {
    os << "reject_reason_code=\"" << snap_deep::reject_reason_code::to_string(msg.fields.reject_reason_code.get().value()) << '"'
       ;
    return os;
}
...
inline std::ostream& operator<<(std::ostream& os, const snapshot_data_message& msg) {
    os << "iex_tp_header=\"" << msg.fields.iex_tp_header.get().value() << '"'
       ...
       << ",iex_tp_message_type=\"" << snap_deep::iex_tp_message_type::to_string(msg.fields.iex_tp_message_type.get().value()) << '"'
...
inline std::ostream& operator<<(std::ostream& os, const system_event_message& msg) {
    os << "system_event=\"" << snap_deep::system_event::to_string(msg.fields.system_event.get().value()) << '"'
...
inline std::ostream& operator<<(std::ostream& os, const security_directory_message& msg) {
    os << "security_directory_flags=" << static_cast<unsigned>(msg.fields.security_directory_flags.get().value())
       ...
       << ",luld_tier=\"" << snap_deep::luld_tier::to_string(msg.fields.luld_tier.get().value()) << '"'
       ;
    return os;
}

inline std::ostream& operator<<(std::ostream& os, const trading_status_message& msg) {
    os << "trading_status=\"" << snap_deep::trading_status::to_string(msg.fields.trading_status.get().value()) << '"'
       << ",timestamp=" << msg.fields.timestamp.get().value()
       << ",symbol=\"" << msg.fields.symbol.get_trimmed().value() << '"'
...
inline std::ostream& operator<<(std::ostream& os, const retail_liquidity_indicator_message& msg) {
    os << "retail_liquidity_indicator=\"" << snap_deep::retail_liquidity_indicator::to_string(msg.fields.retail_liquidity_indicator.get().value()) << '"'
       << ",timestamp=" << msg.fields.timestamp.get().value()
       << ",symbol=\"" << msg.fields.symbol.get_trimmed().value() << '"'
       ;
    return os;
...
inline std::ostream& operator<<(std::ostream& os, const operational_halt_status_message& msg) {
    os << "operational_halt_status=\"" << snap_deep::operational_halt_status::to_string(msg.fields.operational_halt_status.get().value()) << '"'
       << ",timestamp=" << msg.fields.timestamp.get().value()
       << ",symbol=\"" << msg.fields.symbol.get_trimmed().value() << '"'
       ;
    return os;
...
inline std::ostream& operator<<(std::ostream& os, const short_sale_price_test_status_message& msg) {
    os << "short_sale_price_test_status=\"" << snap_deep::short_sale_price_test_status::to_string(msg.fields.short_sale_price_test_status.get().value()) << '"'
       << ",timestamp=" << msg.fields.timestamp.get().value()
       << ",symbol=\"" << msg.fields.symbol.get_trimmed().value() << '"'
       << ",detail=\"" << snap_deep::detail::to_string(msg.fields.detail.get().value()) << '"'
       ;
    return os;
}

inline std::ostream& operator<<(std::ostream& os, const security_event_message& msg) {
    os << "security_event=\"" << snap_deep::security_event::to_string(msg.fields.security_event.get().value()) << '"'
       << ",timestamp=" << msg.fields.timestamp.get().value()
       << ",symbol=\"" << msg.fields.symbol.get_trimmed().value() << '"'
       ;
    return os;
...
inline std::ostream& operator<<(std::ostream& os, const price_level_buy_update_message& msg) {
    os << "event_flags=\"" << snap_deep::event_flags::to_string(msg.fields.event_flags.get().value()) << '"'
       << ",timestamp=" << msg.fields.timestamp.get().value()
       << ",symbol=\"" << msg.fields.symbol.get_trimmed().value() << '"'
...
inline std::ostream& operator<<(std::ostream& os, const official_price_message& msg) {
    os << "price_type=\"" << snap_deep::price_type::to_string(msg.fields.price_type.get().value()) << '"'
       << ",timestamp=" << msg.fields.timestamp.get().value()
       << ",symbol=\"" << msg.fields.symbol.get_trimmed().value() << '"'
...
inline std::ostream& operator<<(std::ostream& os, const auction_information_message& msg) {
    os << "auction_type=\"" << snap_deep::auction_type::to_string(msg.fields.auction_type.get().value()) << '"'
       << ",timestamp=" << msg.fields.timestamp.get().value()
       << ",symbol=\"" << msg.fields.symbol.get_trimmed().value() << '"'
       ...
       << ",imbalance_side=\"" << snap_deep::imbalance_side::to_string(msg.fields.imbalance_side.get().value()) << '"'
