        ...
        case message_type::enum_type::snapshot_data_message: {
            switch (system_event_message::parse(buffer)->iex_tp_message_type.get().value()) {
                ...
                case iex_tp_message_type::enum_type::security_event_message:
                    ...
                    break;
                case iex_tp_message_type::enum_type::price_level_buy_update_message:
                    handler.on_message(*price_level_buy_update_message::parse(buffer));
                    break;
                case iex_tp_message_type::enum_type::price_level_sell_update_message:
                    handler.on_message(*price_level_sell_update_message::parse(buffer));
                    break;
                case iex_tp_message_type::enum_type::trade_report_message:
                    handler.on_message(*trade_report_message::parse(buffer));
                    break;
                case iex_tp_message_type::enum_type::official_price_message:
                ...
                case iex_tp_message_type::enum_type::trade_break_message:
                    ...
                    break;
                case iex_tp_message_type::enum_type::auction_information_message:
