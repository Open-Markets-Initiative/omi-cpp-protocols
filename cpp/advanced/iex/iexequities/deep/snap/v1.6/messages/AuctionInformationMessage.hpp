...
struct auction_information_message {
    ...
    struct fields_type {
        snap_deep::auction_type auction_type;
        snap_deep::timestamp timestamp;
        snap_deep::symbol symbol;
        snap_deep::paired_shares paired_shares;
        snap_deep::reference_price reference_price;
        snap_deep::indicative_clearing_price indicative_clearing_price;
        snap_deep::imbalance_shares imbalance_shares;
        snap_deep::imbalance_side imbalance_side;
        snap_deep::extension_number extension_number;
        snap_deep::scheduled_auction_time scheduled_auction_time;
        snap_deep::auction_book_clearing_price auction_book_clearing_price;
        snap_deep::collar_reference_price collar_reference_price;
        snap_deep::lower_auction_collar lower_auction_collar;
