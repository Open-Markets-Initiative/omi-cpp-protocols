...
// layout verification
static_assert(offsetof(order_executed_message::fields_type, stock_locate) == 0, "unexpected offset of order_executed_message::fields_type::stock_locate");
static_assert(offsetof(order_executed_message::fields_type, tracking_number) == 2, "unexpected offset of order_executed_message::fields_type::tracking_number");
static_assert(offsetof(order_executed_message::fields_type, timestamp) == 4, "unexpected offset of order_executed_message::fields_type::timestamp");
static_assert(offsetof(order_executed_message::fields_type, order_reference_number) == 10, "unexpected offset of order_executed_message::fields_type::order_reference_number");
