...
struct inverse_indicator {
    ...
    static constexpr std::array<std::pair<std::string_view, enum_type>, 2> from_string_map = {{
        {"Inverse Etp", enum_type::inverse_etp},
        {"Not Inverse Etp", enum_type::not_inverse_etp}
    }};

    static constexpr std::string_view to_string(enum_type value) {
        switch (value) {
            case enum_type::inverse_etp: return "Inverse Etp";
            case enum_type::not_inverse_etp: return "Not Inverse Etp";
