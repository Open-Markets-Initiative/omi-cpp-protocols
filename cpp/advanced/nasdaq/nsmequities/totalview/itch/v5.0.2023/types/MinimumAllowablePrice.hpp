...
struct minimum_allowable_price {

    static constexpr const char* name = "minimum_allowable_price";
    ...
    constexpr minimum_allowable_price()
     : value{ 0 } {}

    minimum_allowable_price(std::uint32_t v)
