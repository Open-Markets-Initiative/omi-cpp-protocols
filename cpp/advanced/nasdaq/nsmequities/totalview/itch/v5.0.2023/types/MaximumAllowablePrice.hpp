...
struct maximum_allowable_price {

    static constexpr const char* name = "maximum_allowable_price";
    ...
    constexpr maximum_allowable_price()
     : value{ 0 } {}

    maximum_allowable_price(std::uint32_t v)
