...
struct upper_price_range_collar {

    static constexpr const char* name = "upper_price_range_collar";
    ...
    constexpr upper_price_range_collar()
     : value{ 0 } {}

    upper_price_range_collar(std::uint32_t v)
