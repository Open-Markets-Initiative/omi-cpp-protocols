...
MessageCode OfficialPriceMessage::type() const { return message_type; }
...
void OfficialPriceMessage::accept(Visitor& visitor) const {
    visitor.visit(*this);
}

std::unique_ptr<Message> OfficialPriceMessage::clone() const {
...
bool OfficialPriceMessage::equals(const Message& other) const {
