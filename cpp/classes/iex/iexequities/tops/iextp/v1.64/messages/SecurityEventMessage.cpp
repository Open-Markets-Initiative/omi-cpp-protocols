...
MessageCode SecurityEventMessage::type() const { return message_type; }
...
void SecurityEventMessage::accept(Visitor& visitor) const {
    visitor.visit(*this);
}

std::unique_ptr<Message> SecurityEventMessage::clone() const {
...
bool SecurityEventMessage::equals(const Message& other) const {
