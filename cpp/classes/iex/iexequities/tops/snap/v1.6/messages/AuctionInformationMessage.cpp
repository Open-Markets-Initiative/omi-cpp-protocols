...
IexTpMessageDataCode AuctionInformationMessage::type() const { return message_type; }
...
void AuctionInformationMessage::accept(IexTpMessageDataVisitor& visitor) const {
    visitor.visit(*this);
}

std::unique_ptr<IexTpMessageData> AuctionInformationMessage::clone() const {
...
bool AuctionInformationMessage::equals(const IexTpMessageData& other) const {
