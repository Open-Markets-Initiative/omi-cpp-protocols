...
IexTpMessageDataCode TradeBreakMessage::type() const { return message_type; }
...
void TradeBreakMessage::accept(IexTpMessageDataVisitor& visitor) const {
    visitor.visit(*this);
}

std::unique_ptr<IexTpMessageData> TradeBreakMessage::clone() const {
...
bool TradeBreakMessage::equals(const IexTpMessageData& other) const {
