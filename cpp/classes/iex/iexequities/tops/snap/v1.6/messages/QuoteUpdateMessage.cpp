...
IexTpMessageDataCode QuoteUpdateMessage::type() const { return message_type; }
...
void QuoteUpdateMessage::accept(IexTpMessageDataVisitor& visitor) const {
    visitor.visit(*this);
}

std::unique_ptr<IexTpMessageData> QuoteUpdateMessage::clone() const {
...
bool QuoteUpdateMessage::equals(const IexTpMessageData& other) const {
