...
IexTpMessageDataCode OrderModifyMessage::type() const { return message_type; }
...
void OrderModifyMessage::accept(IexTpMessageDataVisitor& visitor) const {
    visitor.visit(*this);
}

std::unique_ptr<IexTpMessageData> OrderModifyMessage::clone() const {
...
bool OrderModifyMessage::equals(const IexTpMessageData& other) const {
