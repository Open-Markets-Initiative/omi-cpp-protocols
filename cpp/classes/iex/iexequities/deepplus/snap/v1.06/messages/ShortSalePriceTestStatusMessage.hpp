...
class ShortSalePriceTestStatusMessage : public IexTpMessageData {
  public:
    // The code that selects this message
    static constexpr IexTpMessageDataCode message_type = IexTpMessageType::ShortSalePriceTestStatusMessage;
