...
IexTpMessageDataCode OrderDeleteMessage::type() const { return message_type; }
...
void OrderDeleteMessage::accept(IexTpMessageDataVisitor& visitor) const {
    visitor.visit(*this);
}

std::unique_ptr<IexTpMessageData> OrderDeleteMessage::clone() const {
...
bool OrderDeleteMessage::equals(const IexTpMessageData& other) const {
