...
IexTpMessageDataCode OperationalHaltStatusMessage::type() const { return message_type; }
...
void OperationalHaltStatusMessage::accept(IexTpMessageDataVisitor& visitor) const {
    visitor.visit(*this);
}

std::unique_ptr<IexTpMessageData> OperationalHaltStatusMessage::clone() const {
...
bool OperationalHaltStatusMessage::equals(const IexTpMessageData& other) const {
