...
IexTpMessageDataCode SecurityDirectoryMessage::type() const { return message_type; }
...
void SecurityDirectoryMessage::accept(IexTpMessageDataVisitor& visitor) const {
    visitor.visit(*this);
}

std::unique_ptr<IexTpMessageData> SecurityDirectoryMessage::clone() const {
...
bool SecurityDirectoryMessage::equals(const IexTpMessageData& other) const {
