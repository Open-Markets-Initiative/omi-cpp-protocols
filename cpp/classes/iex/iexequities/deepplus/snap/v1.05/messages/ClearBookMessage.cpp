...
IexTpMessageDataCode ClearBookMessage::type() const { return message_type; }
...
void ClearBookMessage::accept(IexTpMessageDataVisitor& visitor) const {
    visitor.visit(*this);
}

std::unique_ptr<IexTpMessageData> ClearBookMessage::clone() const {
...
bool ClearBookMessage::equals(const IexTpMessageData& other) const {
