...
IexTpMessageDataCode AddOrderMessage::type() const { return message_type; }
...
void AddOrderMessage::accept(IexTpMessageDataVisitor& visitor) const {
    visitor.visit(*this);
}

std::unique_ptr<IexTpMessageData> AddOrderMessage::clone() const {
...
bool AddOrderMessage::equals(const IexTpMessageData& other) const {
