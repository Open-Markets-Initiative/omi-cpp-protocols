...
MessageCode ShortSalePriceTestStatusMessage::type() const { return message_type; }
...
void ShortSalePriceTestStatusMessage::accept(Visitor& visitor) const {
    visitor.visit(*this);
}

std::unique_ptr<Message> ShortSalePriceTestStatusMessage::clone() const {
...
bool ShortSalePriceTestStatusMessage::equals(const Message& other) const {
