...
MessageCode TradeMessage::type() const { return message_type; }
...
void TradeMessage::accept(Visitor& visitor) const {
    visitor.visit(*this);
}

std::unique_ptr<Message> TradeMessage::clone() const {
...
bool TradeMessage::equals(const Message& other) const {
