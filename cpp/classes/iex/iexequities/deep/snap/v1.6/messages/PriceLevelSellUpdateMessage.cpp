...
IexTpMessageDataCode PriceLevelSellUpdateMessage::type() const { return message_type; }
...
void PriceLevelSellUpdateMessage::accept(IexTpMessageDataVisitor& visitor) const {
    visitor.visit(*this);
}

std::unique_ptr<IexTpMessageData> PriceLevelSellUpdateMessage::clone() const {
...
bool PriceLevelSellUpdateMessage::equals(const IexTpMessageData& other) const {
