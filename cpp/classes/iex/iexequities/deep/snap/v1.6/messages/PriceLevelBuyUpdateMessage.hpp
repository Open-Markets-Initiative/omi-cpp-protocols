...
class PriceLevelBuyUpdateMessage : public IexTpMessageData {
  public:
    // The code that selects this message
    static constexpr IexTpMessageDataCode message_type = IexTpMessageType::PriceLevelBuyUpdateMessage;
    // Bytes of this message on the wire
    static constexpr std::size_t wire_size = 29;

    PriceLevelBuyUpdateMessage() = default;
    PriceLevelBuyUpdateMessage(EventFlags event_flags, std::chrono::nanoseconds timestamp, const std::string& symbol, std::uint32_t size, Decimal price);
    ...
    bool operator==(const PriceLevelBuyUpdateMessage& other) const;
    bool operator!=(const PriceLevelBuyUpdateMessage& other) const;
