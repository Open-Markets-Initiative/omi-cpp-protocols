...
void TradeReportMessage::accept(Visitor& visitor) const {
    visitor.visit(*this);
}

std::unique_ptr<Message> TradeReportMessage::clone() const {
...
bool TradeReportMessage::equals(const Message& other) const {
