...
MessageCode PriceLevelBuyUpdateMessage::type() const { return message_type; }
...
void PriceLevelBuyUpdateMessage::accept(Visitor& visitor) const {
    visitor.visit(*this);
}

std::unique_ptr<Message> PriceLevelBuyUpdateMessage::clone() const {
...
bool PriceLevelBuyUpdateMessage::equals(const Message& other) const {
