...
MessageCode RetailLiquidityIndicatorMessage::type() const { return message_type; }
...
void RetailLiquidityIndicatorMessage::accept(Visitor& visitor) const {
    visitor.visit(*this);
}

std::unique_ptr<Message> RetailLiquidityIndicatorMessage::clone() const {
...
bool RetailLiquidityIndicatorMessage::equals(const Message& other) const {
