...
std::string_view to_string(MessageType value) {
    switch (value) {
        ...
        case MessageType::PriceLevelBuyUpdateMessage: return "Price Level Buy Update Message";
        case MessageType::PriceLevelSellUpdateMessage: return "Price Level Sell Update Message";
