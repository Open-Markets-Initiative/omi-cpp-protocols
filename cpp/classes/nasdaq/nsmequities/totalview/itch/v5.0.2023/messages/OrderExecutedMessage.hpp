...
class OrderExecutedMessage : public Message {
  public:
    ...
    OrderExecutedMessage(std::uint16_t stock_locate, std::uint16_t tracking_number, std::chrono::nanoseconds timestamp, std::uint64_t order_reference_number, std::uint32_t executed_shares, std::uint64_t match_number);
